              ...
              <div className="p-6 pb-4">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex gap-1">
                    ...
                    <button onClick={() => setQuizzes(quizzes.filter(q => q.id !== quiz.id))} className="p-1.5 text-zinc-600 dark:text-zinc-400 hover:text-red-400 rounded transition-colors bg-zinc-100 dark:bg-zinc-800/0 hover:bg-zinc-100 dark:bg-zinc-800">
