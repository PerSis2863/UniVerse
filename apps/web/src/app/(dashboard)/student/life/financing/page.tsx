        ...
        <div className="max-w-5xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-indigo-500/10 border border-indigo-500/20 p-6 rounded-2xl">
              ...
              <div className="text-zinc-600 dark:text-zinc-400 text-sm font-medium mb-1">Current Balance</div>
              <div className="text-3xl font-bold text-zinc-900 dark:text-white">$0.00</div>
            ...
            <div className="bg-emerald-500/10 border border-emerald-500/20 p-6 rounded-2xl">
              ...
              <div className="text-zinc-600 dark:text-zinc-400 text-sm font-medium mb-1">Financial Aid</div>
              <div className="text-3xl font-bold text-zinc-900 dark:text-white">$4,500</div>
            ...
            <div className="bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 p-6 rounded-2xl flex flex-col justify-between">
              <div>
                <h3 className="font-semibold text-zinc-900 dark:text-white mb-2">Need Help?</h3>
                <p className="text-sm text-zinc-600 dark:text-zinc-400">Schedule a meeting with a financial aid counselor.</p>
              </div>
              <button onClick={() => toast.success('Booking appointment...')} className="w-full py-2 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-700 text-zinc-900 dark:text-white rounded-lg transition-colors text-sm font-medium">
                Book Appointment
              </button>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden">
            <div className="px-6 py-4 border-b border-zinc-200 dark:border-zinc-800 flex justify-between items-center">
              ...
              <button onClick={() => window.open('/assets/dummy.pdf', '_blank')} className="text-sm text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:text-white flex items-center gap-2">
              ...
              {[
                ...
                <div key={i} className="px-6 py-4 flex justify-between items-center">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="font-medium text-zinc-900 dark:text-white">{tx.desc}</div>
                      <div className="text-xs text-zinc-500 dark:text-zinc-500">{tx.date}</div>
                    </div>
                  </div>
                  <div className={`font-semibold ${tx.type === 'credit' ? 'text-emerald-400' : 'text-zinc-900 dark:text-white'}`}>
                    {tx.amount}
                  </div>
                </div>
              ))}
