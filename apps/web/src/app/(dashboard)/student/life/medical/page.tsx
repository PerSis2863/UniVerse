      ...
      <div className="flex-1 p-8 overflow-y-auto">
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Health Center */}
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8 relative overflow-hidden group hover:border-pink-500/30 transition-colors">
              ...
              <h2 className="text-2xl font-bold text-white mb-2">Campus Health Center</h2>
              <p className="text-zinc-400 mb-6">Book appointments for general medical care, vaccinations, and routine checkups.</p>
            ...
            {/* Disability Services */}
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8 relative overflow-hidden group hover:border-purple-500/30 transition-colors">
              ...
              <h2 className="text-2xl font-bold text-white mb-2">Disability Support</h2>
              <p className="text-zinc-400 mb-6">Request academic accommodations, accessible housing, and assistive technology.</p>
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6">
            <h3 className="font-semibold text-white mb-4">Upcoming Appointments</h3>
