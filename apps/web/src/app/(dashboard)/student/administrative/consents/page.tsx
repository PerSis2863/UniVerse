      ...
      <div className="flex-1 p-8 overflow-y-auto">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-indigo-500/20 rounded-xl p-6 flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white mb-1">Privacy matters to us</h3>
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl overflow-hidden">
            <div className="p-6 border-b border-zinc-800 bg-zinc-900/80">
              <h3 className="text-lg font-semibold text-white">Data Sharing Preferences</h3>
            </div>
            
            <div className="divide-y divide-zinc-800">
              
              <div className="p-6 flex items-center justify-between gap-6 hover:bg-zinc-800/30 transition-colors">
                <div>
                  <div className="font-medium text-white mb-1">Marketing & Communications</div>
                  <div className="text-sm text-zinc-400">Receive promotional emails about university events, merchandise, and third-party offers.</div>
                </div>
              ...
              <div className="p-6 flex items-center justify-between gap-6 hover:bg-zinc-800/30 transition-colors">
                <div>
                  <div className="font-medium text-white mb-1">Alumni Network Directory</div>
                  <div className="text-sm text-zinc-400">Allow your name, major, and graduation year to be visible in the alumni network directory after graduation.</div>
                </div>
              ...
              <div className="p-6 flex items-center justify-between gap-6 hover:bg-zinc-800/30 transition-colors">
                <div>
                  <div className="font-medium text-white mb-1">Photo & Media Release</div>
                  <div className="text-sm text-zinc-400">Consent to the university using photographs or video footage containing your likeness for promotional materials and websites.</div>
                </div>
              ...
              <div className="p-6 flex items-center justify-between gap-6 hover:bg-zinc-800/30 transition-colors">
                <div>
                  <div className="font-medium text-white mb-1">Academic Research Data</div>
                  <div className="text-sm text-zinc-400">Allow anonymized academic performance data to be used by university researchers for educational studies.</div>
                </div>
