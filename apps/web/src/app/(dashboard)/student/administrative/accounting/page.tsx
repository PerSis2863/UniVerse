        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-red-500/10 to-orange-500/10 border border-red-500/20 rounded-xl p-6">
              ...
              <div className="mt-4">
                <button onClick={() => toast.success('Pay Now clicked')} className="w-full bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg font-medium transition-colors">
                  Pay Now
                </button>
              </div>
            </div>
            ...
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-medium text-zinc-400">Payment Methods</h3>
              </div>
              <div className="text-lg font-medium text-white mt-1">Visa ending in 4242</div>
              <div className="text-sm text-zinc-500 mb-3">Expires 12/28</div>
            ...
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-medium text-zinc-400">Next Payment Due</h3>
              </div>
              <div className="text-lg font-medium text-white mt-1">Jan 15, 2027</div>
              <div className="text-sm text-zinc-500 mb-3">Spring 2027 Tuition</div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-zinc-800">
                  ...
                  <th className="p-4 text-sm font-medium text-zinc-400">Description</th>
                  <th className="p-4 text-sm font-medium text-zinc-400">ID</th>
                  <th className="p-4 text-sm font-medium text-zinc-400 text-right">Amount</th>
                  <th className="p-4 text-sm font-medium text-zinc-400 text-right">Status</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-zinc-800/50">
                {TRANSACTIONS.map((trx) => (
                  <tr key={trx.id} className="hover:bg-zinc-800/30 transition-colors">
                    ...
                    <td className="p-4">
                      <div className="font-medium text-white">{trx.desc}</div>
                      <div className="text-xs text-zinc-500">{trx.type}</div>
                    </td>
                    <td className="p-4 text-sm text-zinc-500">{trx.id}</td>
