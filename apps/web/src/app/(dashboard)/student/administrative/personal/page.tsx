      ...
      <div className="flex-1 p-8 overflow-y-auto">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-xl p-8 flex flex-col md:flex-row items-center md:items-start gap-8 relative">
            <button onClick={() => toast.success('Edit Profile clicked')} className="absolute top-4 right-4 text-zinc-500 dark:text-zinc-500 hover:text-zinc-900 dark:text-white transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="md:col-span-2 bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-xl p-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 bg-zinc-100 dark:bg-zinc-800/30 border border-zinc-700/50 rounded-lg">
                  <div className="flex justify-between items-start mb-2">
                    <div className="font-medium text-zinc-900 dark:text-white">Jane Doe</div>
                    <span className="text-xs font-medium text-indigo-400 bg-indigo-500/10 px-2 py-0.5 rounded-full">Primary</span>
                  </div>
                  <div className="text-sm text-zinc-600 dark:text-zinc-400 mb-2">Relationship: Mother</div>
                  <div className="flex items-center gap-2 text-sm text-zinc-300">
                    <Phone className="w-4 h-4 text-zinc-500 dark:text-zinc-500" /> +1 (555) 987-6543
                  </div>
                </div>
              </div>
            </div>
