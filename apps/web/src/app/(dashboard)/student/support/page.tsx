      ...
      <div className="flex-1 p-8 overflow-y-auto">
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 hover:border-indigo-500/50 transition-colors cursor-pointer group">
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400">Browse our comprehensive guides and tutorials for using the platform.</p>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 hover:border-indigo-500/50 transition-colors cursor-pointer group">
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400">Chat directly with a support representative. Available 9AM - 5PM EST.</p>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 hover:border-indigo-500/50 transition-colors cursor-pointer group">
              ...
              <h3 className="text-lg font-semibold text-zinc-900 dark:text-white mb-2">IT Helpdesk</h3>
              <p className="text-sm text-zinc-600 dark:text-zinc-400">Having technical issues? Contact the university IT helpdesk directly.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-xl p-8">
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-6">Submit a Ticket</h3>
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="space-y-2">
                  ...
                  <input type="text" placeholder="Brief description of the issue" className="w-full bg-zinc-100 dark:bg-zinc-800/50 border border-zinc-700 rounded-lg px-4 py-2 text-zinc-900 dark:text-white focus:outline-none focus:border-indigo-500 transition-colors" />
                </div>
                
                <div className="space-y-2">
                  <label className="text-sm font-medium text-zinc-600 dark:text-zinc-400">Description</label>
                  <textarea rows={4} placeholder="Please provide as much detail as possible..." className="w-full bg-zinc-100 dark:bg-zinc-800/50 border border-zinc-700 rounded-lg px-4 py-2 text-zinc-900 dark:text-white focus:outline-none focus:border-indigo-500 transition-colors"></textarea>
                </div>

                <button className="w-full flex items-center justify-center gap-2 bg-indigo-500 hover:bg-indigo-600 text-zinc-900 dark:text-white px-6 py-3 rounded-lg font-medium transition-colors mt-2">
