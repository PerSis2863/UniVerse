      ...
      <div className="flex-1 p-8 overflow-y-auto">
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="bg-gradient-to-r from-indigo-500/20 to-purple-500/20 border border-indigo-500/30 rounded-xl p-6 flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-2">Campus Closure Notice</h3>
              ...
              <div className="mt-3 text-sm text-zinc-500 dark:text-zinc-500">Posted on October 12, 2026 by Administration</div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-xl p-5 space-y-5">
                <div className="flex gap-4 cursor-pointer hover:bg-zinc-100 dark:bg-zinc-800/30 p-2 -mx-2 rounded-lg transition-colors" onClick={(e) => handleLinkClick(e, 'Career Fair Details')}>
                  ...
                  <div>
                    <h4 className="font-medium text-zinc-900 dark:text-white mb-1">Career Fair 2026</h4>
                    <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-1">Main Student Center • 10:00 AM - 4:00 PM</p>
                    <p className="text-xs text-zinc-500 dark:text-zinc-500">Connect with top employers for internships and full-time roles.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 cursor-pointer hover:bg-zinc-100 dark:bg-zinc-800/30 p-2 -mx-2 rounded-lg transition-colors" onClick={(e) => handleLinkClick(e, 'Guest Lecture Details')}>
                  ...
                  <div>
                    <h4 className="font-medium text-zinc-900 dark:text-white mb-1">Guest Lecture: Tech Ethics</h4>
                    <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-1">Auditorium A • 2:00 PM - 3:30 PM</p>
                    <p className="text-xs text-zinc-500 dark:text-zinc-500">Join Dr. Sarah Jenkins for a talk on AI and Ethics.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 cursor-pointer hover:bg-zinc-100 dark:bg-zinc-800/30 p-2 -mx-2 rounded-lg transition-colors" onClick={(e) => handleLinkClick(e, 'Workshop Details')}>
                  ...
                  <div>
                    <h4 className="font-medium text-zinc-900 dark:text-white mb-1">Midterm Preparation Workshop</h4>
                    <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-1">Library Study Hall • 5:00 PM - 7:00 PM</p>
                    <p className="text-xs text-zinc-500 dark:text-zinc-500">Learn effective study strategies and time management.</p>
                  </div>
                </div>
              </div>
            </div>
